function App() {
  return (
    <>
      <main className="flex min-h-screen items-center justify-center bg-[#D5E1EF]">
        <div className="flex h-[499px] w-[320px] flex-col items-center rounded-2xl bg-white p-4 shadow-lg">
          ...
          <p className="mt-4 text-center text-[15px] leading-[140%] tracking-[0.2px] text-[#68778D]">
      ...
      <footer className="text-center text-[#68778D]">
        Challenge by{' '}
        <a
